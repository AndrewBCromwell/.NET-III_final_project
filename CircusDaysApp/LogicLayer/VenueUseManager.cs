...
namespace LogicLayer
{
    public class VenueUseManager : IVenueUseManager
    {
        ...
        public bool AddVenueUse(VenueUseVM venueUse)
        {
            bool success = false;
            try
            {
                int rowsAfected = venueUseAccessor.InsertVenueUse(venueUse.VenueId, venueUse.StartDate, venueUse.EndDate, venueUse.EmployeeId);
                if (rowsAfected == 1)
                {
                    success = true;
                }
        ...
        public bool AddUseDay(UseDay day)
        {
            bool success = false;
        ...
        public VenueUseVM RetreiveVenueUseByUseId(int id)
        {
            VenueUseVM venueUse = new VenueUseVM();
            try
            {
                venueUse = venueUseAccessor.SelectVenueUseByUseId(id);

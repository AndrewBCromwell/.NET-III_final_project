            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    else //not an existing user, create a user without roles
                    {
                        ...
                        var employeeID = empMgr.CreateEmployee(employee); // add the DataObjects.Employee to Employee table
                        var user = new ApplicationUser // create identity user
                        {

...
/* Insert zip_code sp */
print '' print '*** creating sp_insert_zip_code'
GO
...
AS
	BEGIN
		IF NOT EXISTS (SELECT [zip_code] FROM [zip_code] WHERE [zip_code] = @zip_code)
			BEGIN
				INSERT INTO [dbo].[zip_code]
					([zip_code], [city], [state])
				VALUES
...
print '' print '*** creating sp_insert_ad_company'
GO
CREATE PROCEDURE [sp_insert_ad_company](
...
CREATE TABLE [dbo].[use_day] (
    ...
    CONSTRAINT [pk_use_day] PRIMARY KEY ([use_id], [use_date]),
...
AS
	BEGIN
		...
		[venue].[terms_of_use], [venue].[phone_number], [venue].[active]
	END
GO

print '' print '*** creating procedure sp_insert_venue'
GO
...
print '' print '*** creating procedure sp_update_venue_by_id'
GO
CREATE PROCEDURE [sp_update_venue_by_id](
	@venue_id			[INT],
	@old_venue_name			[NVARCHAR](50),
	@old_street_address		[NVARCHAR](50),
	@old_zip_code			[CHAR](5),
	@old_phone_number		[NVARCHAR](20),
	@old_terms_of_use		[NVARCHAR](500),
	@old_active			[TINYINT],
	@venue_name			[NVARCHAR](50),
	@street_address		[NVARCHAR](50),
	@zip_code			[CHAR](5),
...
AS
	BEGIN
		...
		[venue_name] = @old_venue_name AND 
		[street_address] = @old_street_address AND
		[zip_code] = @old_zip_code AND
		[phone_number] = @old_phone_number AND
		[terms_of_use] = @old_terms_of_use AND
		[active] = @old_active
	END
GO
...
print '' print '*** creating sp_select_venue_use_by_use_id'
GO
CREATE PROCEDURE [sp_select_venue_use_by_use_id]
(
	@UseId		[INT]
)
AS
